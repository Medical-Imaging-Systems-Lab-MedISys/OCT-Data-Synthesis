#!/bin/bash
#SBATCH --job-name=RETFound_OCT5k_Frozen
#SBATCH --output=logs/retfound_oct5k_frozen_%j.out
#SBATCH --error=logs/retfound_oct5k_frozen_%j.err
#SBATCH --nodes=1
...
export LOCAL_DATA_DIR="/tmp/OCT5k_frozen_${SLURM_JOB_ID}"
...
# Execute Training with frozen backbone and proper MLflow run name
echo "Starting Frozen RETFound Segmentation Training on OCT5k..."
...
/data/vds/env_pt/bin/python train_oct5k.py \
    ...
    --freeze_backbone \
    --run_name "RETFound_OCT5k_Frozen"
