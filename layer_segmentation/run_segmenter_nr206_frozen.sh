#!/bin/bash
#SBATCH --job-name=RETFound_NR206_Frozen
#SBATCH --output=logs/retfound_nr206_frozen_%j.out
#SBATCH --error=logs/retfound_nr206_frozen_%j.err
#SBATCH --nodes=1
...
export LOCAL_DATA_DIR="/tmp/NR206_frozen_${SLURM_JOB_ID}"
...
# Execute Training
echo "Starting Frozen RETFound Segmentation Training on NR206..."
...
/data/vds/env_pt/bin/python train_nr206.py \
    ...
    --freeze_backbone \
    --run_name "RETFound_NR206_Frozen_WM_Removed"
