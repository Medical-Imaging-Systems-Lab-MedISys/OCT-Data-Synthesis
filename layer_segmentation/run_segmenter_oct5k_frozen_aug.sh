#!/bin/bash
#SBATCH --job-name=RETFound_OCT5k_Frozen_Aug
#SBATCH --output=logs/retfound_oct5k_frozen_aug_%j.out
#SBATCH --error=logs/retfound_oct5k_frozen_aug_%j.err
#SBATCH --nodes=1
...
export LOCAL_DATA_DIR="/tmp/OCT5k_frozen_aug_${SLURM_JOB_ID}"
...
# Execute Training
echo "Starting Frozen RETFound Segmentation Training on OCT5k (with Augmentations)..."
...
/data/vds/env_pt/bin/python train_oct5k.py \
    ...
    --freeze_backbone \
    --use_augmentations \
    --run_name "RETFound_OCT5k_Frozen_Aug"
