...
from dataset_octid import OCTIDDataset

# --- Hyperparameters ---
BATCH_SIZE = 16
EPOCHS = 50
LEARNING_RATE = 1e-4
NUM_CLASSES = 8   # 0=vitreous, 1-6=retinal layers, 7=choroid
...
def train():
    parser = argparse.ArgumentParser(
        description="Train RETFound Segmenter on OCTID dataset")
    parser.add_argument('--data_dir', type=str, required=True,
                        help="Root OCTID directory (parent of "
    ...
    parser.add_argument('--run_name', type=str,
                        default="RETFound_OCTID_Finetune_Aug_256",
    ...
    # 1. Prepare Data
    train_dataset = OCTIDDataset(
        data_dir=args.data_dir,
        split='train',
        img_size=args.img_size,
        use_augmentations=args.use_augmentations,
    )
    val_dataset = OCTIDDataset(
        data_dir=args.data_dir,
        split='val',
        img_size=args.img_size,
    ...
    mlflow.set_experiment("OCTID_Segmentation")
    ...
    with mlflow.start_run(run_name=args.run_name):
        ...
        mlflow.set_tag(
            ...
            "Dataset: OCTID retinal layer segmentation (JPEG images + "
            "boundary CSV files). "
            "NUM_CLASSES=8: 0=vitreous, 1-6=retinal layers, 7=choroid. "
            "Boundaries converted to pixel masks via column-wise interpolation"
            " of 7 boundary curves (convert_octid_masks.py). "
            ...
            "80/20 subject-level train/val split (seed=42)."
        )
