#!/bin/bash
#SBATCH --job-name=RETFound_NR206_Finetune
#SBATCH --output=logs/retfound_nr206_finetune_%j.out
#SBATCH --error=logs/retfound_nr206_finetune_%j.err
#SBATCH --nodes=1
...
export LOCAL_DATA_DIR="/tmp/NR206_finetune_${SLURM_JOB_ID}"
...
# Execute Training
echo "Starting RETFound Finetune Segmentation Training on NR206..."
...
/data/vds/env_pt/bin/python train_nr206.py \
    ...
    --run_name "RETFound_NR206_Finetune_WM_Removed"
